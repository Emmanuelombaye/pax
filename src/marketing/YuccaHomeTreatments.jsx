...
const TREATMENTS = [
  {
    ...
    vials: [`${IMG}/personalized-semaglutide-glp-1-injection-vial-yucca-health.avif?v=paxbrand`],
  ...
  },
  {
    ...
    period: '/mo',
    priceNote: '6-month plan · charged only if prescribed',
    vials: [`${IMG}/personalized-tirzepatide-glp-1-injection-vial-yucca-health.avif?v=paxbrand`],
